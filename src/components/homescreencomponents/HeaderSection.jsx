    ...
    return (
        <>
            <div className="text-center w-4/6 lg:w-1/2 bg-white mx-auto my-40 space-y-4 text-gray-900">
                <h1 className="text-5xl font-BowlbyOne">Ready-built Components for <span
            ...
            <div className="flex flex-row justify-center space-x-4 md:space-x-12 mx-auto md:mx-20 pb-20 text-gray-900">
