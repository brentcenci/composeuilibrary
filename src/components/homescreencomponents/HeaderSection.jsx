const HeaderSection = () => {
    return (
        <div className="text-center w-4/6 bg-white mx-auto my-10 space-y-4 text-gray-900">
            <h1 className="text-5xl font-BowlbyOne">Ready-built Components for <span className="text-blue-700">Compose</span></h1>
